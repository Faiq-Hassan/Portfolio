		...
		<div class="container-fluid">
			<div class="header-wrapper">
				...
				<div class="header-logo">
					<a href="#"><img src="assets/images/FH.png" alt="hello"></a>
				</div>
				<!-- Header Nav -->
	...
	<main data-bs-spy="scroll" data-bs-target=".nav-box">
		...
		<div id="about" class="hero-section">
			<div class="container text-center">
				<div class="row">
					<div class="col-12">
						<h1 class="hero-heading display-1 fw-bold mb-0 stroke-text ">Faiq Hassan</h1>
					</div>
				</div><!-- end row -->
			</div><!-- end container -->
		</div>
				...
				<div class="col-12 col-lg-4 order-lg-1">
					<div class="row g-4 g-lg-5">
						<div class="col-12 col-md-4 col-lg-12">
							...
							<p>I transform ideas into stunning , high performing blending creativity and precision to exceed expectations.</p>
						</div>
					...
					<div class="col-12 col-xl-8">
						<div class="row g-4 g-lg-5">
							<div class="col-12 col-md-6">
								...
								<h3 class="mb-0">faiqghumman4@gmail.com</h3>
							</div>
							<div class="col-12 col-md-6">
								<h6 class="sm-heading">Call:</h6>
								<h3 class="mb-0">+92-309-4902818</h3>
							</div>
						</div><!-- end row(inner) -->
						<!-- Contact Form -->
						<div class="contact-form mt-4 mt-lg-5 text-xl-end">
							...
							<div class="submit-result">
								<span id="success" style="display:none; color: green;">✅ Thank you! Your message has been sent.</span>
								<span id="error" style="display:none; color: red;">❌ Something went wrong, please try again!</span>
							</div>
						</div>
